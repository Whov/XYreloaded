package org.altervista.whovian.events;

import org.altervista.whovian.multipart.ItemMultiPartWire;
...
private ThreadLocal<Object> placing = new ThreadLocal<Object>();
	...
	public static boolean place(EntityPlayer player, World world)
    {
        ...
        if(heldBlock == XYreloaded.blockWire)
            part = WirePart.placement(player.worldObj, pos, hit.sideHit);
