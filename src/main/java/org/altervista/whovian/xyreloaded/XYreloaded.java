...
public class XYreloaded {
	...
	public static Block blockWireInput;
	...
	public static Block fabricatorUpgradeBlock;
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		blockWire = new Wire();
		blockWireInput = new WireInput();
		riceBlock = new RiceBlock();
		fabricator = new Fabricator();
		fabricatorUpgradeBlock = new FabUpgrades();
		...
		GameRegistry.registerBlock(fabricatorUpgradeBlock, ItemFabUpgrade.class, "fabricatorupgradeblock");
		...
		GameRegistry.registerBlock(blockWireInput, "blockWireInput");
        ...
        if(FMLCommonHandler.instance().getSide().isClient())
            PacketCustom.assignHandler(this, new PacketHandlerClient());
        
        MinecraftForge.addGrassSeed(new ItemStack(riceSeeds), 4);
	...
	public void init(FMLInitializationEvent event) {
		...
		GameRegistry.registerTileEntity(TileEntityDummyTank.class, "tileDummyTank");
