...
public class GuiHandler implements IGuiHandler {
	...
	public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
		switch (ID) {
			...
			case XYreloaded.guiFab2: return new ContainerFabricatorConfig(player.inventory, ((TileEntityFabricator)world.getTileEntity(x, y, z)));
		}
		return null;
	}
	...
	public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
		switch (ID) {
			...
			case XYreloaded.guiFab2: return new GUIfabricatorConfig(player.inventory, ((TileEntityFabricator)world.getTileEntity(x, y, z)));
		}
		return null;
	}
